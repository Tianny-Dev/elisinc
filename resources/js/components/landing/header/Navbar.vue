<template>
    <nav
        ...
        class="relative mt-20 flex items-center justify-between rounded-2xl border border-neutral-200 bg-white px-6 py-4 shadow-sm sm:mt-0 dark:border-neutral-800 dark:bg-neutral-900"
    >
        <!-- Logo -->
